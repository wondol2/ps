...
alias todo="vim ~/memo/todo.txt"
alias vimrc="vim ~/.vimrc"
alias bashrc="vim ~/.bashrc"
alias bashrcsource="source ~/.bashrc"
alias template="vim ~/ps/scripts/template.cpp"
alias input="vim ~/ps/scripts/input.txt"
...
tg(){
    ...
    cp -i ~/ps/scripts/generater_template.cpp $file_name.cpp
    vim $file_name.cpp
}
...
c(){
    ...
    g++ -I/home/wondol/ps/scripts -O2 -lm -std=c++17 -o $file_name.out $file_name.cpp
    ./$file_name.out
    rm -f $file_name.out
}
